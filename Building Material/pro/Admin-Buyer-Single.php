...
$abs="select * from buyer where BuyerID='$bid'";
...
.button:hover span:after
 {
    ...
    <body>
        ...
        </header>         <header class="main_header_area">
            <div class="header_top_area">
                <div class="container">
                  <h2 style="margin: 15px; color: white;">Welcome to WeBuild Market Place(Where Buying and Selling Made Easier)</h2>
                    </div>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Accounts</a>
                                    <ul class="dropdown-menu">
                                        <li class="active"><a href="Admin-Create.Acc.php">Create Account</a></li>
                                        <li><a href="Admin-Acc-Info.php">My Account</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                            ...
                            <h4>Password : "; echo "<td>{$row3['Bpassword']}</td>"; echo "</h4>
                            ";
                            $id1="{$row3['BuyerID']}";
    						$_SESSION['id1']=$id1;
    						echo "
                        ...
                        <br><br>
                        <button class='button' type='submit' name='submit6' style='margin-right: -30px;'><span>Proceed</span></button>
