...
$aacc="select * from admin where UserName='$user'";
$resaa=mysqli_query($con,$aacc);
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        <?php $row3=mysqli_fetch_array($resaa,MYSQLI_ASSOC); ?>
                        <div class="f_content_item" style="margin-top: -40px; text-align: center;">
                            <i class="fa fa-ge" aria-hidden="true"></i>
                            <h4>Name : <?php echo "<td>{$row3['AdminName']}</td>"; ?></h4>
                            <h4>ID : <?php echo "<td>{$row3['AdminID']}</td>"; ?></h4>
                            <h4>Phone Number : <?php echo "<td>{$row3['PhoneNumber']}</td>"; ?></h4>
                            <h4>Email : <?php echo "<td>{$row3['Email']}</td>"; ?></h4>
                            <h4>UserName : <?php echo "<td>{$row3['UserName']}</td>"; ?></h4>
                            <h4>Password : <?php echo "<td>{$row3['Apassword']}</td>"; ?></h4>
                        </div>
                    </div>
                </div>
            </div>
