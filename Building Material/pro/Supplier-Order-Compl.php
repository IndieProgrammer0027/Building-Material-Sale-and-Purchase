...
$comporder="select orders.*,vendor.VendorName from orders inner join supplier on orders.SupplierID=supplier.SupplierID inner join vendor on orders.VendorID=vendor.VendorID where supplier.UserName='$user' And OrderStatus like 'Completed'";
    ...
    <body>
      ...
      <section class="latest_news_area">
            <div class="container">
                ...
                while($rows>0)
                {
                while($row=mysqli_fetch_array($resco,MYSQLI_ASSOC))
                {
                echo "
                    <div class='col-md-4 col-sm-6'>
                        <div class='latest_news_item'>
                            <div class='l_date'>
                                <h5>Date : "; echo "<td>{$row['OrderTimeDate']}</td>"; echo "</h5>
                            </div>
