...
$allads="select * from advertisement where AdStatus like 'Active'";
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="active"><a href="Buyer-Advertisement-Main.php">View Advertisements</a></li>
       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2><br class="title_br">Advertisements</h2>
                </div>

                <form class="nbox" action="Buyer-Advertisement-Single.php" method="POST">
                <center>
                <br>
                            ...
                            <div class='project_hover'>
                                <div class='project_hover_inner'>
                                    <div class='project_hover_content'>
                                        ...
                                        echo "<br>";
                                        echo "</p>
                                        <a class='view_btn' href='Buyer-Advertisement-Dynamic.php?Aid=$id'>View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
