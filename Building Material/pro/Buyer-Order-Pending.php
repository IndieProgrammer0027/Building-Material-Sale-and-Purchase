...
$penorder="select orders.*,buyer.BuyerName from orders inner join vendor on orders.vendorID=vendor.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where buyer.UserName='$user' And OrderStatus like 'Pending'";
