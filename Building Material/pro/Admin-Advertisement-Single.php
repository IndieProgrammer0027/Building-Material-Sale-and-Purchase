...
$aas="select * from advertisement where advertisement.AdvertisementID='$aaid'";
$resaas=mysqli_query($con,$aas);
$rows=mysqli_num_rows($resaas);

if(isset($_POST['sub1']))
{
      header("location:  Admin-Advertisement-Status.php");
}
?>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resaas,MYSQLI_ASSOC);
                            ...
                            <h4>Details : </h4><p>"; echo "<td>{$row3['Details']}</td>"; echo "</p>
                    ...
                    else if($rows<=0)
                    {
                        ...
                        echo "
                        <form class='nbox' action='Admin-Advertisement-Status1.php' method='POST'>
                        <center>
                        <br>
                        ...
                        <input type=radio button name='ad' value='DeActive'><b style='font-size : 20px;'>Disable</b><br>
                        <input type=radio button name='ad' value='AdminDeActive'><b style='font-size : 20px;'>Administratively Disable</b>
                        <br><br>
