...
$vss="select supplier.* from supplier inner join orders on orders.SupplierID=supplier.SupplierID inner join buyer on buyer.BuyerID=orders.BuyerID where buyer.UserName='$user' and supplier.SupplierID='$sid'";
$resvss=mysqli_query($con,$vss);
$rows=mysqli_num_rows($resvss);
?>
        ...
        <!--================Header Area =================-->
         ...
         <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>VSupplier<br class="title_br">Information</h2>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resvss,MYSQLI_ASSOC);
