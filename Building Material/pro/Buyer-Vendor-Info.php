...
$allvendors="select * from vendor inner join orders on orders.VendorID=vendor.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where buyer.UserName='$user'";
$resav=mysqli_query($con,$allvendors);
$rows=mysqli_num_rows($resav);
?>
...
.button:hover span:after
 {
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="active"><a href="Buyer-Vendor-Info.php">Vendor Info</a></li>
      ...
      <section class="feature_content">
        ...
        <form class="nbox" action="Buyer-Vendor-Single.php" method="POST">
            <center>
        <br>
         <b>Vendor-ID</b><br>
         <input type=text placeholder="Vendor ID" name="Buid">
        ...
        <button class="button" type="reset" name="res"><span>Reset</span></button>
            ...
            <div class="container">
                ...
                ";while($rows>0)
                {
                while($row3=mysqli_fetch_array($resav,MYSQLI_ASSOC))
                {
                echo "
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    <p>VendorName : " ; echo "<td>{$row3['VendorName']}</td>"; echo "</p>
                                    <h4>Vendor Phone No. : "; echo "<td>{$row3['PhoneNo']}</td>"; echo "</h4>
                                    ";
                                    $id="{$row3['VendorID']}";
                                    echo "<br>";
                                    echo "</p>
                                    <a class='view_btn' href='Buyer-Vendor-Dynamic.php?Buid=$id'>View</a>
                                    <br><br>
                                    </center>
                                    </div>
                                </div>
