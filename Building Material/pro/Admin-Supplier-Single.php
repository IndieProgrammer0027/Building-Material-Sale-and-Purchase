...
$as="select supplier.* from supplier where supplier.SupplierID='$sid'";
$resas=mysqli_query($con,$as);
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resas,MYSQLI_ASSOC);
                        ...
                        $_SESSION['id1']=$id1;
                        echo "
                        <button class='button' type='submit' name='submit4' style='margin-right: -30px;'><span>Proceed</span></button>
