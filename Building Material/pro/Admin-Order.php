...
$allorder="select orders.*,buyer.* from orders inner join buyer on buyer.BuyerID=orders.BuyerID";
...
<section class="latest_news_area">
            <div class="container">
                ...
                <form class="nbox" action="Admin-Order-Single.php" method="POST">
                <center>
                <br>
                <b>Order-ID</b><br>
                <input type=text placeholder="Order ID" name="aOid">
                    ...
                    <div class='col-md-4 col-sm-6' style='margin-bottom: 25px;'>
                        <div class='latest_news_item'>
                            ...
                            <div class='news_content'>
                                ...
                                $id="{$row3['OrderID']}";
                                echo "
                                <a href='Admin-Order-Dynamic.php?aOid=$id'>Read More <i class='fa fa-angle-right' aria-hidden='true'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
