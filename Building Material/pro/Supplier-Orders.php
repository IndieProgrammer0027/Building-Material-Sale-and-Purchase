...
$allorder="select orders.*,vendor.VendorName from orders inner join supplier on orders.SupplierID=supplier.SupplierID inner join vendor on orders.VendorID=vendor.VendorID where supplier.UserName='$user'";
$resao=mysqli_query($con,$allorder);
$rows=mysqli_num_rows($resao)
...
.button:hover span:after
 {
    ...
    <body>
        ...
        <section class="latest_news_area">
            <div class="container">
                <div class="main_c_b_title">
                    <h2>All<br class="title_br">Orders</h2>
                </div>
                ...
                while($rows>0)
                {
                while($row=mysqli_fetch_array($resao,MYSQLI_ASSOC))
                {
                echo "
                    <div class='col-md-4 col-sm-6'>
                        <div class='latest_news_item'>
                            ...
                            <div class='news_content'>
                                ...
                                <h5>Posted By Vendor Name "; echo "<td>{$row['VendorName']}</td>"; echo "</h5>
                                <br>
