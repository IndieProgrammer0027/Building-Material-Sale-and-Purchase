...
$vbs="select bill.*,supplier.SupplierID,supplier.SupplierName from bill inner join supplier on supplier.SupplierID=bill.SupplierID inner join vendor on vendor.VendorID=bill.VendorID where vendor.UserName='$user' AND bill.BillID='$billid'";
$resvbs=mysqli_query($con,$vbs);
$rows=mysqli_num_rows($resvbs);

    $value=$_POST['or'];
    $_SESSION['ran1']=$value;

    if(isset($_POST['subvbi']))
    {
         $data="bill";
        $_SESSION['use']=$data;
        $_SESSION['id']=$billid;
         header("location:  Vendor-OB-Status.php");
     }
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resvbs,MYSQLI_ASSOC);
                        ...
                        <input type=radio button name='or' value='Pending' style='margin-left : -48px;'><b style='font-size : 20px;'>Pending</b>
                        <input type=radio button name='or' value='Completed'><b style='font-size : 20px;'>Recieved</b>
                        <br><br>
                        <button class='button' type='submit' name='subvbi' style='margin-right: -30px;'><span>Proceed</span></button>
                    ...
                    <div class="col-md-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5>jail road,near punjab cardiology </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="row footer_widgets_inner">
                        <div class="col-md-3 col-sm-6">
                            <aside class="f_widget about_widget">
                                ...
                                <p>
                                     We’re a global product and tech group. +20 brands. 5000 people. One mindset.
                                     We empower people to upgrade their lives. Our products & services make it super easy for anyone to buy or sell almost anything.Every month 350 million people use our market-leading trading platforms such as Avito, letgo, dubizzle, and a dozen other local brands. We’re going for a billion.
                                  </p>
                                <ul>
                            ...
                            <aside class="f_widget address_widget">
                                ...
                                <div class="address_w_inner">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p>jail road,near punjab cardiology</p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
