...
$svs="select vendor.*,orders.OrderID,bill.BillID from vendor inner join orders on vendor.VendorID=orders.VendorID inner join buyer on buyer.BuyerID=orders.BuyerID inner JOIN bill on bill.VendorID=vendor.VendorID where buyer.UserName='$user' AND vendor.VendorID='$buid'";
