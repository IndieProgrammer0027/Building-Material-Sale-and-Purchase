...
$activeads="select * from advertisement inner join vendor on advertisement.vendorID=vendor.VendorID where vendor.UserName='$user' And AdStatus='Active'";
$resaa=mysqli_query($con,$activeads);
...
.button:hover span:after
 {
    ...
    <body>
       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2>Active<br class="title_br">Advertisements</h2>
                </div>
