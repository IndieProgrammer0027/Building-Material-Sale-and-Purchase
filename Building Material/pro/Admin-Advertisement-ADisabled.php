...
$deaads="select * from advertisement where AdStatus='AdminDeActive'";
$resada=mysqli_query($con,$deaads);
$rows=mysqli_num_rows($resada);
?>
...
.button:hover span:after
 {
    ...
    <body>
       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2>Admin De Active<br class="title_br">Advertisements</h2>
                </div>

                <form class="nbox" action="Admin-Advertisement-Single.php" method="POST">
                <center>
                <br>
                ...
                <div class='row our_project_details'>";
                 while($rows>0)
                {
                while($row3=mysqli_fetch_array($resada,MYSQLI_ASSOC))
                {
                echo "
