...
$allsupp="select * from supplier where SupplierStatus='Available'";
...
.button:hover span:after
 {
    ...
    <header class="main_header_area">
        ...
        <form class="nbox" action="Vendor-Supplier-Single-Status.php" method="POST">
            <center>
        <br>
         <b>Supplier-ID</b><br>
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    echo " <h4>Phone Number : "; echo "<td>{$row3['PhoneNumber']}</td>";
                                    echo " <h4>Supplier Status : "; echo "<td>{$row3['SupplierStatus']}</td>";
                                    
                                     $id="{$row3['SupplierID']}";
                                     echo "<br><br>";
                                     echo "</h4>
                                    <a class='view_btn' href='Vendor-Supplier-Dynamic-Status.php?Sid=$id'>View</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
