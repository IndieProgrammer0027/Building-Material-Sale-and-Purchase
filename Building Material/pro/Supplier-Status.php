...
$sacc="select * from supplier where UserName='$user'";
$ressa=mysqli_query($con,$sacc);
$rows=mysqli_num_rows($ressa);
?>
        ...
        <!--================Header Area =================-->
         ...
         <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>Account<br class="title_br">Information</h2>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($ressa,MYSQLI_ASSOC);

                            echo "
                        <div class='f_content_item' style='margin-top: -40px; text-align: center;'>
                            <i class='fa fa-ge' aria-hidden='true'></i>
                            <h4>Name : "; echo "<td>{$row3['SupplierName']}</td>"; echo "</h4>
                            <h4>Phone Number : "; echo "<td>{$row3['PhoneNumber']}</td>"; echo "</h4>
                            <h4>Address : "; echo "<td>{$row3['Address']}</td>"; echo "</h4>
                            <h4>Email : "; echo "<td>{$row3['Email']}</td>"; echo "</h4>
                            <h4>UserName : "; echo "<td>{$row3['UserName']}</td>"; echo "</h4>
                            <h4>Status : "; echo "<td>{$row3['SupplierStatus']}</td>"; echo "</h4>
                            <br>
                            ";
                            $sid="{$row3['SupplierID']}";
                            $_SESSION['sid']=$sid;
                            ...
                            <form action='Supplier-Status-Confirm.php' method='POST'> 

                            <input type=radio name='stat' value='available'>Available
                            <input type=radio name='stat' value='occupied'>Occupied

                            <br><br>

                            <button class='button' type='submit' name='sub'><span>Confirm</span></button>
