...
$vbs="select bill.* from bill inner join buyer on buyer.BuyerID=bill.BuyerID where buyer.UserName='$user' AND bill.BillID='$billid'";
...
$rows=mysqli_num_rows($resvbs);
    ...
    if(isset($_POST['subbbi']))
    {
         $data="bill";
        $_SESSION['use']=$data;
        $_SESSION['id']=$billid;
         header("location:  Buyer-OB-Status.php");
     }
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <br><br>
                        <button class='button' type='submit' name='subbbi' style='margin-right: -30px;'><span>Proceed</span></button>
