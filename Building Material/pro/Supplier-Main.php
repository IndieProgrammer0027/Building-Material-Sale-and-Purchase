...
$torders="Select count(OrderID) from orders o inner join Supplier on o.SupplierID=Supplier.SupplierID where Supplier.Username='$user'";
$resto=mysqli_query($con,$torders);
$row3=mysqli_fetch_assoc($resto);

$corders="Select count(OrderID) from orders o inner join Supplier on o.SupplierID=Supplier.SupplierID where Supplier.Username='$user' And OrderStatus like 'Completed'";
$resco=mysqli_query($con,$corders);
$row4=mysqli_fetch_assoc($resco);

$porders="Select count(OrderID) from orders o inner join Supplier on o.SupplierID=Supplier.SupplierID where Supplier.Username='$user' And OrderStatus like 'Pending'";
$respo=mysqli_query($con,$porders);
$row5=mysqli_fetch_assoc($respo);

$tbills="Select count(BillID) from bill b inner join Supplier on b.SupplierID=Supplier.SupplierID where Supplier.Username='$user'";
$restb=mysqli_query($con,$tbills);
$row=mysqli_fetch_assoc($restb);

$cbills="Select count(BillID) from bill b inner join Supplier on b.SupplierID=Supplier.SupplierID where Supplier.Username='$user' And BillStatus like 'Completed'";
$rescb=mysqli_query($con,$cbills);
$row1=mysqli_fetch_assoc($rescb);

$pbills="Select count(BillID) from bill b inner join Supplier on b.SupplierID=Supplier.SupplierID where Supplier.Username='$user' And BillStatus like 'Pending'";
$respb=mysqli_query($con,$pbills);
$row2=mysqli_fetch_assoc($respb);

$details1="select * FROM bill b inner join Supplier on b.SupplierID=Supplier.SupplierID where Supplier.Username='$user' ORDER BY BillID DESC LIMIT 1";
$resd1=mysqli_query($con,$details1);
$row6=mysqli_fetch_assoc($resd1);

$details2="select * FROM bill b inner join Supplier on b.SupplierID=Supplier.SupplierID where Supplier.Username='$user' ORDER BY BillID DESC LIMIT 1,1";
$resd2=mysqli_query($con,$details2);
$row7=mysqli_fetch_assoc($resd2);

$details4="select * FROM orders o inner join Supplier on o.SupplierID=Supplier.SupplierID where Supplier.Username='$user' ORDER BY OrderID DESC LIMIT 1";
$resd4=mysqli_query($con,$details4);
$row9=mysqli_fetch_assoc($resd4);

$details5="select * FROM orders o inner join Supplier on o.SupplierID=Supplier.SupplierID where Supplier.Username='$user' ORDER BY OrderID DESC LIMIT 1,1";
                ...
                <div class="col-md-6">
                    <div class="pre_construction_item">
                        ...
                        <div class="pre_hover">
                            ...
                            $id="{$row9['OrderID']}";
                            echo "</p>
                            <a class='slider_btn' href='Supplier-Order-Dynamic.php?Oid=$id'>Read Details</a>
                ";
            }
                else if($rows<=0)
                {
                ...
                <div class="col-md-6">
                    <div class="pre_construction_item">
                        ...
                        <div class="pre_hover">
                            ...
                            {
                                echo "
                            <h4>Bill No. : "; echo "<td>{$row6['BillID']}</td>"; echo "</h4>
                            <p>"; echo "<td>{$row6['Details']}</td>"; 
                            $id="{$row6['BillID']}";
                            echo "</p>
                            <a class='slider_btn' href='Supplier-Bill-Dynamic.php?Bid=$id'>Read Details</a>
                ";
            }
                else if($rows<=0)
                {
               ...
               <div class="col-md-6">
                    <div class="pre_construction_item">
                        ...
                        <div class="pre_hover">
                            ...
                            {
                                echo "
                            <h4>Bill No. : "; echo "<td>{$row7['BillID']}</td>"; echo "</h4>
                            <p>"; echo "<td>{$row7['Details']}</td>";
                            $id="{$row7['BillID']}";
                            echo "</p>
                            <a class='slider_btn' href='Supplier-Bill-Dynamic.php?Bid=$id'>Read Details</a>
                ";
