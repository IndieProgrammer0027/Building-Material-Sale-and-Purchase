...
$allvendors="select * from vendor";
$reaav=mysqli_query($con,$allvendors);
$rows=mysqli_num_rows($reaav);
?>
...
.button:hover span:after
 {
    ...
    <body>
      ...
      <section class="feature_content">
        ...
        <form class="nbox" action="Admin-Vendor-Single.php" method="POST">
            <center>
        <br>
         <b>Vendor-ID</b><br>
        ...
        <button class="button" type="reset" name="res"><span>Reset</span></button>
            ...
            <div class="container">
                ...
                ";while($rows>0)
                {
                while($row3=mysqli_fetch_array($reaav,MYSQLI_ASSOC))
                {
                echo "
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    <p>VendorName : " ; echo "<td>{$row3['VendorName']}</td>";
                                     $id="{$row3['VendorID']}";
                                     echo "<br><br>";
                                     echo "</p>
                                    <a class='view_btn' href='Admin-Vendor-Dynamic.php?Vid=$id'>View</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
