...
$vacc="select * from vendor where UserName='$user'";
$resva=mysqli_query($con,$vacc);
$rows=mysqli_num_rows($resva)
?>
...
<html lang="en">
 ...
 <header class="main_header_area">
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="Vendor-Supplier-Info.php">Supplier Info</a></li>
                                <li><a href="Vendor-Acc-Up.php">Upgrade Account</a></li>
                                <li class="active"><a href="Account-Info.php">Account Info</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </nav>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <?php $row3=mysqli_fetch_array($resva,MYSQLI_ASSOC); ?>
                        <center>
                        <div class="f_content_item" style="margin-left: 535px; margin-top: -40px;">
                            <i class="fa fa-ge" aria-hidden="true"></i>
                            <h4><?php echo "Name : <td>{$row3['VendorName']}</td>"; ?></h4>
                            <h4><?php echo "Phone Nunber : <td>{$row3['PhoneNo']}</td>"; ?></h4>
                            <h4><?php echo "Address : <td>{$row3['Address']}</td>"; ?></h4>
                            <h4><?php echo "Email : <td>{$row3['Email']}</td>"; ?></h4>
                            <h4><?php echo "Shop Name : <td>{$row3['VendorShopName']}</td>"; ?></h4>
                            <h4><?php echo "Membership : <td>{$row3['MemberShip']}</td>"; ?></h4>
                            <h4><?php echo "UserName : <td>{$row3['UserName']}</td>"; ?></h4>
                        </div>
                        </center>
                    </div>
                </div>
        ...
        <!--================Address Area =================-->
        <section class="address_area" style="margin-top: 50px;">
            <div class="container">
