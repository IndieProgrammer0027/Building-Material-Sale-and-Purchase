...
$deads="select * from advertisement inner join vendor on advertisement.vendorID=vendor.VendorID where vendor.UserName='$user' And AdStatus='DeActive'";
$resda=mysqli_query($con,$deads);
$rows=mysqli_num_rows($resda)
?>
    ...
    <body>
     ...
     <header class="main_header_area">
       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2>De Active<br class="title_br">Advertisements</h2>
                </div>

                <form class="nbox" action="Vendor-Advertisement-Single.php" method="POST">
                <center>
                <br>
                <b>Advertisement-ID</b><br>
                <input type=text placeholder="Advertisement ID" name="Aid">
                ...
                <div class='row our_project_details'>";
                 while($rows>0)
                {
                while($row3=mysqli_fetch_array($resda,MYSQLI_ASSOC))
                {
                echo "
                            ...
                            <div class='project_hover'>
                                <div class='project_hover_inner'>
                                    <div class='project_hover_content'>
                                        <h4>Advertisement No. "; echo "<td>{$row3['AdvertisementID']}</td>"; echo "</h4>
                                        <p>"; echo "<td>{$row3['Details']}</td>";
                                        $id="{$row3['AdvertisementID']}";
                                        echo "<br>";
                                        echo "</p>
                                        <a class='view_btn' href='Vendor-Advertisement-Dynamic.php?Aid=$id'>View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
