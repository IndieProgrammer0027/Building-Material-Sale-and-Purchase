...
.button:hover span:after
 {
    ...
    <header class="main_header_area">
        ...
        <form class="nbox" action="Vendor-Supplier-Single.php" method="POST">
            <center>
        <br>
         <b>Supplier-ID</b><br>
                            ...
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    echo " <p>Supplier Name : "; echo "<td>{$row3['PhoneNumber']}</td>";
                                     ...
                                     echo "<br><br>";
                                     echo "</p>
                                    <a class='view_btn' href='Vendor-Supplier-Dynamic.php?Sid=$id'>View</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
