...
$vas="select * from advertisement where advertisement.AdvertisementID='$Aid' And AdStatus like 'Active'";
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li class="active"><a href="Buyer-Home.php">Home</a></li>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        ";
                        echo "
                        <form class='nbox' action='Buyer-Order-Placement.php' method='POST'>
                        <center>
                        <br>
                        ...
                        <br><br>
                        <input type='text' placeholder='Shipment Addres ' name='sad'><br>
                        
                        <button class='button' type='submit' name='sub10' style='margin-right: -30px;'><span>Place Order</span></button>
                        </center>
                        </form>
                        ";
                    }
