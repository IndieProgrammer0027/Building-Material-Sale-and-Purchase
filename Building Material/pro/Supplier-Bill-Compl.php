...
$combills="select * from bill inner join supplier on bill.SupplierID=supplier.SupplierID where supplier.UserName='$user' AND BillStatus like 'Completed'";
$rescb=mysqli_query($con,$combills);
$rows=mysqli_num_rows($rescb)
?>
...
.button:hover span:after
 {
    ...
    <body>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <h4 class="counter"><?php 
                             ...
                             ?></h4>
                            <h5>All Payments</h5>
                                <a class="get_btn" href="Supplier-Bills-Main.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <a class="get_btn" href="Supplier-Bill-Compl.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <a class="get_btn" href="Supplier-Bill-Pending.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--================Our Project2 Area =================-->
           <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>Completed<br class="title_br">Payments</h2>
            </div>
        </section>
       ...
       <section class="our_service_area2">
            <div class="container">
                ...
                <form class="nbox" action="Supplier-Bill-Single.php" method="POST">
                <center>
                <br>
                <b>Payment-ID</b><br>
                ...
                while($rows>0)
                {
                while($row3=mysqli_fetch_array($rescb,MYSQLI_ASSOC))
                {
                echo "
