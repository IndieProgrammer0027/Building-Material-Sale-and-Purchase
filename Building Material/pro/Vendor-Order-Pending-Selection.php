    ...
    <header class="main_header_area">
       ...
       <section class="latest_news_area">
            <div class="container">
                ...
                <form class="nbox" action="Vendor-Order-Single-Confirmation.php" method="POST">
                <center>
                <br>
                <b>Order-ID</b><br>
                    ...
                    <div class='col-md-4 col-sm-6'>
                        <div class='latest_news_item'>
                            ...
                            <div class='news_content'>
                                ...
                                $id="{$row3['OrderID']}";
                                echo "
                                <a href='Vendor-Order-Dynamic-Confirmation.php?Oid=$id'>Read More <i class='fa fa-angle-right' aria-hidden='true'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
