...
$allbills="select * from bill inner join buyer on bill.BuyerID=buyer.BuyerID where buyer.Username='$user' And BillStatus like'Pending'";
    ...
    <body>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="Buyer-Bill-Pending.php">Pending Payments</a></li>
        ...
        <section class="our_service_area2">
            <div class="container">
                ...
                <form class="nbox" action="Buyer-Bill-Single.php" method="POST">
                <center>
                <br>
                <b>Payment-ID</b><br>
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    $id="{$row3['BillID']}";
                                    echo "</p>
                                    <a class='view_btn' href='Buyer-Bill-Dynamic.php?Bid=$id'>Read</a>
                                </div>
                            </div>
                        </div>
                    </div>
