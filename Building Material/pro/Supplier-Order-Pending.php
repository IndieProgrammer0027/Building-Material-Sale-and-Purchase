...
$penorder="select orders.*,vendor.VendorName from orders inner join supplier on orders.SupplierID=supplier.SupplierID inner join vendor on orders.VendorID=vendor.VendorID where supplier.UserName='$user' And OrderStatus like 'Pending'";
$respo=mysqli_query($con,$penorder);
$rows=mysqli_num_rows($respo)
    ...
    <body>
       ...
       <section class="our_project2_area our_project_three_column">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <h4 class="counter">
                             ...
                             ?></h4>
                            <h5>All Orders</h5>
                                <a class="get_btn" href="Supplier-Order.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <a class="get_btn" href="Supplier-Order-Compl.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="counter_item">
                            ...
                            <a class="get_btn" href="Supplier-Order-Pending.php" style="margin-top: 10px; font-size: 15px;">View</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="latest_news_area">
            <div class="container">
                <div class="main_c_b_title">
                    <h2>Pending<br class="title_br">Orders</h2>
                </div>
                
                 <form class="nbox" action="Supplier-Order-Single.php" method="POST">
                <center>
                <br>
                <b>Order-ID</b><br>
                ...
                while($rows>0)
                {
                while($row=mysqli_fetch_array($respo,MYSQLI_ASSOC))
                {
                echo "
                    <div class='col-md-4 col-sm-6'>
                        <div class='latest_news_item'>
                            <div class='l_date'>
                                <h5> "; echo "<td>{$row['OrderTimeDate']}</td>"; echo "</h5>
                            </div>
                            <div class='news_content'>
                                <h4>Order No.  "; echo "<td>{$row['OrderID']}</td>"; echo "</h4>
                                <h5>Posted By Vendor No. "; echo "<td>{$row['VendorID']}</td>"; echo "</h5>
                                <br>
                                <p>"; echo "<td>{$row['Details']}</td>"; echo "</p>
                                <div>
                                "; 
                                $id="{$row['OrderID']}";
                                echo "
                                <a href='Supplier-Order-Dynamic.php?Oid=$id'>Read More <i class='fa fa-angle-right' aria-hidden='true'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
