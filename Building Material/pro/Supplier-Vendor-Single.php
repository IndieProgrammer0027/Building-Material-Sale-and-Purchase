...
$svs="select vendor.*,orders.OrderID,bill.BillID from vendor inner join orders on vendor.VendorID=orders.VendorID inner join supplier on orders.SupplierID=supplier.SupplierID inner join bill on supplier.SupplierID=bill.SupplierID where supplier.UserName='$user' AND vendor.VendorID='$venid'";
$ressvs=mysqli_query($con,$svs);
$rows=mysqli_num_rows($ressvs);
?>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($ressvs,MYSQLI_ASSOC);
