...
$aos="select orders.*,buyer.BuyerID,buyer.BuyerName,vendor.VendorID,vendor.VendorName from orders inner join vendor on vendor.VendorID=orders.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where OrderID='$orderid'";
$resaos=mysqli_query($con,$aos);
$rows=mysqli_num_rows($resaos);
    ...
    if(isset($_POST['subor']))
    {
        ...
        $_SESSION['use']=$data;
        $_SESSION['id']=$orderid;
        header("location:  Admin-OB-Status.php");
    }
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resaos,MYSQLI_ASSOC);
                        ...
                        <input type=radio button name='or' value='Completed'><b style='font-size : 20px;'>Delivered</b>
                        <input type=radio button name='or' value='Cancel'><b style='font-size : 20px;'>Cancel</b>
                        <input type=radio button name='or' value='Delete'><b style='font-size : 20px;'>Delete</b>
                        <br><br>
                        <button class='button' type='submit' name='subor' style='margin-right: -30px;'><span>Proceed</span></button>
