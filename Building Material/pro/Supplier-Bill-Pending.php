...
$penbills="select * from bill inner join supplier on bill.SupplierID=supplier.SupplierID where supplier.UserName='$user' AND BillStatus like 'Pending'";
$respb=mysqli_query($con,$penbills);
$rows=mysqli_num_rows($respb)
?>
    ...
    <body>
       ...
       <section class="our_service_area2">
            <div class="container">
                ...
                while($rows>0)
                {
                while($row3=mysqli_fetch_array($respb,MYSQLI_ASSOC))
                {
                echo "
