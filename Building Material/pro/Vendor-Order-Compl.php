...
$comporder="select orders.*,buyer.BuyerName from orders inner join vendor on orders.vendorID=vendor.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where vendor.UserName='$user' And OrderStatus like 'Completed'";
