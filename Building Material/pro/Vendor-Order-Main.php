...
$allorder="select orders.*,buyer.BuyerName from orders inner join vendor on orders.vendorID=vendor.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where vendor.UserName='$user'";
   ...
   <header class="main_header_area">
       ...
       <section class="latest_news_area">
            <div class="container">
                ...
                while($rows>0)
                {
                while($row3=mysqli_fetch_array($resao,MYSQLI_ASSOC))
                {
                echo "
