...
$allads="select * from advertisement inner join vendor on advertisement.vendorID=vendor.VendorID where vendor.UserName='$user'";
$resaa=mysqli_query($con,$allads);
$rows=mysqli_num_rows($resaa)
?>
...
.button:hover span:after
 {
    ...
    <body>
       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2>All<br class="title_br">Advertisements</h2>
                </div>
                ...
                <div class='row our_project_details'>";
                 while($rows>0)
                {
                while($row3=mysqli_fetch_array($resaa,MYSQLI_ASSOC))
                {
                echo "
