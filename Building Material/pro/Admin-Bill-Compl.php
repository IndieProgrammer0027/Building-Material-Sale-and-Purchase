...
$cbills="select * from bill where BillStatus like 'Completed'";
$rescb=mysqli_query($con,$cbills);
    ...
    <body>
        ...
        <section class="our_service_area2">
            <div class="container">
                ...
                <form class="nbox" action="Admin-Bill-Single.php" method="POST">
                <center>
                <br>
                <b>Payment-ID</b><br>
                <input type=text placeholder="Payment ID" name="aBid">
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    "; $id="{$row3['BillID']}";
                                    echo "</p><a class='view_btn' href='Admin-Bill-Dynamic.php?aBid=$id'>Read</a>
                                    </div>
                                </div>
                            </div>
                        </div>
