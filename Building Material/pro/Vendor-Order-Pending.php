...
$penorder="select orders.*,buyer.BuyerName from orders inner join vendor on orders.vendorID=vendor.VendorID inner join buyer on orders.BuyerID=buyer.BuyerID where vendor.UserName='$user' And OrderStatus like 'Pending'";
    ...
    <body>
       ...
       <section class="latest_news_area">
            <div class="container">
                ...
                <form class="nbox" action="Vendor-Order-Single.php" method="POST">
                <center>
                <br>
                <b>Order-ID</b><br>
                ...
                while($rows>0)
                {
                while($row3=mysqli_fetch_array($respo,MYSQLI_ASSOC))
                {
                echo "
                    <div class='col-md-4 col-sm-6'>
                        <div class='latest_news_item'>
                            ...
                            <div class='news_content'>
                                ...
                                $id="{$row3['OrderID']}";
                                echo "
                                <a href='Vendor-Order-Dynamic.php?Oid=$id'>Read More <i class='fa fa-angle-right' aria-hidden='true'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
