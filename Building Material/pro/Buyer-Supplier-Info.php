...
$allsupp="select * from supplier inner join orders on orders.SupplierID=supplier.SupplierID inner join buyer on buyer.BuyerID=orders.BuyerID where buyer.UserName='$user'";
$resas=mysqli_query($con,$allsupp);
$rows=mysqli_num_rows($resas);
?>
...
.button:hover span:after
 {
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="Buyer-Main.php">Home</a></li>
                                ...
                                <li class="active"><a href="Buyer-Supplier-Info.php">Supplier Info</a></li>
        ...
        <!--================Header Area =================-->
         ...
         <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>Supplier<br class="title_br">Information</h2>
            </div>
        </section>
        ...
        <form class="nbox" action="Buyer-Supplier-Single.php" method="POST">
            <center>
        <br>
         <b>Supplier-ID</b><br>
         <input type=text placeholder="Supplier ID" name="Sid">
        ...
        <button class="button" type="reset" name="res"><span>Reset</span></button>
            ...
            <div class="container">
                ...
                ";while($rows>0)
                {
                while($row3=mysqli_fetch_array($resas,MYSQLI_ASSOC))
                {
                echo "
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    <p>Supplier Name : "; echo "<td>{$row3['SupplierName']}</td>";
                                    echo " <p>Supplier Name : "; echo "<td>{$row3['PhoneNumber']}</td>";
                                    
                                     $id="{$row3['SupplierID']}";
                                     echo "<br><br>";
                                     echo "</p>
                                    <a class='view_btn' href='Buyer-Supplier-Dynamic.php?Sid=$id'>View</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
