...
$sos="select orders.*,vendor.PhoneNo,vendor.VendorName from orders inner join supplier on supplier.SupplierID=orders.SupplierID inner join vendor on vendor.VendorID=orders.VendorID where supplier.UserName='$user' AND OrderID='$orderid'";
$ressos=mysqli_query($con,$sos);
$rows=mysqli_num_rows($ressos);
?>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($ressos,MYSQLI_ASSOC);
