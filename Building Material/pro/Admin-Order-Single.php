            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <input type=radio button name='ob' value='Completed'><b style='font-size : 20px;'>Delivered</b>
                        <input type=radio button name='ob' value='Cancel'><b style='font-size : 20px;'>Cancel</b>
                        ...
                        $_SESSION['id1']=$id1;
                        echo "
                        <button class='button' type='submit' name='submit7' style='margin-right: -30px;'><span>Proceed</span></button>
