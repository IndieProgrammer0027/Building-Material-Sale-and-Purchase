...
$vbs="select bill.* from bill inner join vendor on vendor.VendorID=bill.VendorID where vendor.UserName='$user' AND bill.BillID='$billid'";
...
$rows=mysqli_num_rows($resvbs);
    ...
    if(isset($_POST['submit11']))
    {
        ...
        $user="bill";
        $_SESSION['use']=$user;
        header("location:  Vendor-OB-Status1.php");
    }
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        $_SESSION['id1']=$id1;
                        echo "
                        <button class='button' type='submit' name='submit11' style='margin-right: -30px;'><span>Proceed</span></button>
