...
$allbuyer="select * from buyer";
$reaab=mysqli_query($con,$allbuyer);
$rows=mysqli_num_rows($reaab);
?>
...
.button:hover span:after
 {
    ...
    <body>
        ...
        <!--================Header Area =================-->
         ...
         <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>Buyer<br class="title_br">Information</h2>
            </div>
        </section>
      ...
      <section class="feature_content">
        ...
        <form class="nbox" action="Admin-Buyer-Single.php" method="POST">
            <center>
        <br>
         <b>Buyer-ID</b><br>
         <input type=text placeholder="Buyer ID" name="Bid">
        ...
        <button class="button" type="reset" name="res"><span>Reset</span></button>
            ...
            <div class="container">
                ...
                ";while($rows>0)
                {
                while($row3=mysqli_fetch_array($reaab,MYSQLI_ASSOC))
                {
                echo "
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    <p>Buyer Name : " ; echo "<td>{$row3['BuyerName']}</td>";
                                     $id="{$row3['BuyerID']}";
                                     echo "<br><br>";
                                     echo "</p>
                                    <a class='view_btn' href='Admin-Buyer-Dynamic.php?Bid=$id'>View</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
