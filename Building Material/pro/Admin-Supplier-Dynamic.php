...
$ass="select supplier.* from supplier where supplier.SupplierID='$sid'";
$resass=mysqli_query($con,$ass);
$rows=mysqli_num_rows($resass);
    ...
    if(isset($_POST['submit1']))
    {
        ...
        $_SESSION['use']=$user;
        $_SESSION['id']=$sid;
        header("location:  Admin-Accounts-Status.php");
    }
?>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resass,MYSQLI_ASSOC);

                            echo "
                            <div class='f_content_item' style='margin-top: -40px; text-align: center;'>
                            <i class='fa fa-ge' aria-hidden='true'></i>
                            <h4>Supplier ID : "; echo "<td>{$row3['SupplierID']}</td>"; echo "</h4>
                            <h4>Supplier Name : "; echo "<td>{$row3['SupplierName']}</td>"; echo "</h4>
                            ...
                            <h4>Password : "; echo "<td>{$row3['Spassword']}</td>"; echo "</h4>
                        </div>
                        ";
                        echo "
                        ...
                        <br><br>
                        <button class='button' type='submit' name='submit1' style='margin-right: -30px;'><span>Proceed</span></button>
