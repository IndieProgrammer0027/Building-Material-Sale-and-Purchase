...
$allvendors="select * from vendor inner join orders on orders.VendorID=vendor.VendorID inner join supplier on orders.supplierID=supplier.SupplierID where supplier.UserName='$user'";
...
.button:hover span:after
 {
    ...
    <body>
      ...
      <section class="feature_content">
        ...
        <form class="nbox" action="Supplier-Vendor-Single.php" method="POST">
            <center>
        <br>
         <b>Vendor-ID</b><br>
                        ...
                        <div class='service2_item'>
                            <div class='service2_item_inner'>
                                <div class='service2_item_inner_content'>
                                    ...
                                    echo "<br>";
                                    echo "</p>
                                    <a class='view_btn' href='Supplier-Vendor-Dynamic.php?Vid=$id'>View</a>
                                    <br><br>
                                    </center>
                                    </div>
                                </div>
