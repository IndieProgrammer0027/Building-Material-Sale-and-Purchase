...
$vas="select advertisement.* from advertisement inner join vendor on advertisement.VendorID=vendor.VendorID where vendor.UserName='$user' AND advertisement.AdvertisementID='$Aid'";
$resvas=mysqli_query($con,$vas);
$rows=mysqli_num_rows($resvas);

if(isset($_POST['sub0']))
{ 
      header("location:  Vendor-Advertisement-Status1.php");
}
    ...
    <header class="main_header_area">
        ...
        <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title">
                <h2>Advertisement<br class="title_br">Information</h2>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        if($rows>0)
                        {
                        $row3=mysqli_fetch_array($resvas,MYSQLI_ASSOC);

                            echo "
                            <div class='f_content_item' style='margin-top: -40px; text-align: center;'>
                            <i class='fa fa-ge' aria-hidden='true'></i>
                            <h4>Advertisement ID : "; echo "<td>{$row3['AdvertisementID']}</td>"; echo "</h4>
                            <h4>Advertisement Name : "; echo "<td>{$row3['AdvertisementName']}</td>"; echo "</h4>
                            <h4>Date : "; echo "<td>{$row3['UploadTimeDate']}</td>"; echo "</h4>
                            <h4>Advertisement Status : "; echo "<td>{$row3['AdStatus']}</td>"; echo "</h4>
                            </div>
                        ";
                        echo "
                        <form class='nbox' action='Vendor-Advertisement-Status1.php' method='POST'>
                        <center>
                        <br>
                        <h4>Advertisement Status</h4><br>
                        <input type=radio button name='ad' value='Active' style='margin-left : 0px;'><b style='font-size : 20px;'>Enable</b>
                        <input type=radio button name='ad' value='DeActive'><b style='font-size : 20px;'>Disable</b>
                        <br><br>
                        ";
                        $id="{$row3['AdvertisementID']}";
                        echo "
                        <button class='button' type='submit' name='sub0' style='margin-right: -30px;'><span>Proceed</span></button>
