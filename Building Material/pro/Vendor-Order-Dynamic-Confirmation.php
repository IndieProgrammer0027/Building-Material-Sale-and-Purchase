...
$rows=mysqli_num_rows($resvos);
    ...
    if(isset($_POST['subvor1']))
    {
        $_SESSION['id11']=$orderid;
        header("location:  Vendor-Supplier-Confirm-Status1.php");
    }
?>
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <center>
                        <br><br>
                        <button class='button' type='submit' name='subvor1' style='margin-right: -30px;'><span>Proceed</span></button>
                        </center>
                        </form>
                        ";
                    }
