...
$vos="select orders.* from orders inner join buyer on buyer.BuyerID=orders.BuyerID where buyer.UserName='$user' AND OrderID='$orderid'";
            ...
            <div class="container">
                <div class="row" style="margin-left: 440px;">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <br><br>
                        <button class='button' type='submit' name='subbor' style='margin-right: -30px;'><span>Proceed</span></button>
