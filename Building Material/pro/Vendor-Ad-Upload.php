       ...
       <section class="our_project2_area project_grid_three">
           <div class="container">
               <div class="main_c_b_title">
                    <h2>Upload<br class="title_br">Advertisement</h2>
                </div>
                    <div class="col-md-4 col-sm-6" style="float: right; margin-right : 265px;">
                        <input type="file" name="img1" accept="image/*" class="button">
                    </div>
           </div>
        </section>

        <section class="our_project2_area our_project_three_column">
            <div class="main_c_b_title" style="margin-top: -40px;">
                <h2 style="font-size: 30px;">Advertisement<br class="title_br">Information</h2>
            </div>
        </section>

        <section class="service_single_area">
            <div class="container" style="margin-top: -250px; margin-bottom: 10px;">
                <div class="service_single_inner">
                    <div class="row s_text_inner">
                        <div class="col-md-6" style="float: right; margin-right : 290px;">
                                <ul>
                                <form class="nbox" action="Advertisement_action.php" method="post">
                                <br>
                                <b>Ad Title</b>
                                <li><input type=text placeholder="Ad name" name="name"></li>

                                <b>Ad Status</b>
                                <br>
                                <input type=radio button name="status" value="Active">Active
                                <input type=radio button name="status" value="DeActive" style="margin-left: 30px;">DeActive
                                <br><br>

                                <br>
                                <b>Description</b>
                                <li><textarea name="desc" placeholder="Description" class="txta"></textarea></li>
                                
                                <b>Item Name</b>
                                <li><input type=text placeholder="Item" name="item"></li>

                                <b>Price</b>
                                <li><input type=text placeholder="Price" name="price"></li>

                                <b>Item Description</b>
                                <li><textarea name="itdesc" placeholder="Details" class="txta"></textarea></li>
